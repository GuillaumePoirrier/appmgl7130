package com.mgl7130.curve.pages.student.profile;
...
public class StudentProfile extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (verifyForm(studentFirstName, studentFamilyName, studentBirthDate)) {
                    try {
                        createDbStudent(studentFirstName, studentFamilyName, studentBirthDate);
                        setFormNonEditable();
                    } catch (Exception e) {
                        System.out.print(e);
                    }
    ...
    private void fillProfile() {
        ...
        StorageReference pathReference = storageRef.child("curve/" + mAuth.getCurrentUser()
                .getUid() + ".jpg");
    ...
    private void createDbStudent(EditText studentFirstName, EditText studentFamilyName, EditText studentBirthDate) throws ParseException {
        ...
        User user = new User(studentFirstName.getText().toString(), studentFamilyName.getText().toString(), birthDate);
