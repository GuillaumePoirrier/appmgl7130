...
public class TeacherClassAdapter extends FirestoreAdapter<TeacherClassAdapter.ViewHolder> {
    ...
    public TeacherClassAdapter(Query query, OnClassSelectedListener listener){
        super(query);
